...
import com.android.print.demo.MyProperties;
...
public class PrintUtils {
    ...
    public static void printText2(Resources resources, PrinterInstance mPrinter) {
        mPrinter.init();
    ...
    public static void printTicket(PrinterInstance mPrinter, String count, String type, String gender, String purpose, String service) {
        mPrinter.init();
        Date now = new Date();
        mPrinter.setPrinter(Command.PRINT_AND_WAKE_PAPER_BY_LINE, 1);

        mPrinter.setPrinter(Command.ALIGN, 1);
        mPrinter.setFont(0, 1, 0, 1);
        mPrinter.printText(type + "\n");

        mPrinter.setPrinter(Command.ALIGN, 1);
        mPrinter.setFont(1, 1, 1, 0);
        mPrinter.printText("Count # " + count + "\n");

        mPrinter.setPrinter(Command.ALIGN, 0);
        mPrinter.setFont(0, 0, 0, 0);
        mPrinter.printText("Gender : " + gender + "\n");

        mPrinter.setPrinter(Command.ALIGN, 0);
        mPrinter.setFont(0, 0, 0, 0);
        mPrinter.printText("Purpose : " + purpose + "\n");

        mPrinter.setPrinter(Command.ALIGN, 0);
        mPrinter.setFont(0, 0, 0, 0);
        mPrinter.printText("Service : " + service + "\n");

        mPrinter.setPrinter(Command.ALIGN, 1);
        mPrinter.setFont(0, 0, 0, 0);
        mPrinter.printText("UNDP   Leaps  #DigitalBangsamoro" + "\n");

        mPrinter.printText(sdf.format(now) + "\n");
...
//Spacer for cutout
        ...
        if (type.startsWith("PRIORITY") == true) {
            ...
            MyProperties.getInstance().regularCount++;
        }
    }
